...
package com.vlath.keyboard.keyboard.internal;
...
public final class KeyboardIconsSet {
    ...
    public static final String NAME_ARROW_UP_KEY = "arrow_up";
    public static final String NAME_ARROW_DOWN_KEY = "arrow_down";
    public static final String NAME_ARROW_RIGHT_KEY = "arrow_right";
    public static final String NAME_ARROW_LEFT_KEY = "arrow_left";
    public static final String NAME_MORE = "more_switch";
    ...
    private static final Object[] NAMES_AND_ATTR_IDS = {
        ...
        NAME_ARROW_UP_KEY,                R.styleable.Keyboard_iconArrowUp,
        NAME_ARROW_DOWN_KEY,              R.styleable.Keyboard_iconArrowDown,
        NAME_ARROW_RIGHT_KEY,             R.styleable.Keyboard_iconArrowRight,
        NAME_ARROW_LEFT_KEY,              R.styleable.Keyboard_iconArrowLeft,
        NAME_MORE,                        R.styleable.Keyboard_iconMore
