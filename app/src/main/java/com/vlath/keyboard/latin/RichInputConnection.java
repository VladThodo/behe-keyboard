...
import com.vlath.keyboard.latin.common.UnicodeSurrogate;
import com.vlath.keyboard.latin.settings.SpacingAndPunctuations;
import com.vlath.keyboard.latin.utils.CapsModeUtils;
import com.vlath.keyboard.latin.utils.DebugLogUtils;
    ...
    public void commitText(final CharSequence text, final int newCursorPosition) {
        ...
        if (isConnected()) {
            ...
            for (final CharacterStyle span : spans) {
                ...
                // See com.vlath.keyboard.latin.common.Constants.UnicodeSurrogate
