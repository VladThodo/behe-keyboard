...
package com.vlath.keyboard.latin.common;
...
public final class Constants {
    ...
    public static final int CODE_LEFT_ARROW = -14;
    public static final int CODE_RIGHT_ARROW = -15;
    public static final int CODE_UP_ARROW = -16;
    public static final int CODE_DOWN_ARROW = - 17;

    public static final int CODE_ARROW_SWITCH = - 18;
    public static final int CODE_TO_ALPHA = - 19;

    public static final int CODE_CTRL = - 20;
    public static final int CODE_ALT = - 21;
